      ...
      <section className="py-12 md:py-16">
        <div className="container max-w-4xl mx-auto">
          <div className="prose prose-lg dark:prose-invert max-w-none">
            ...
            <p className="text-adaptive-secondary">
              We retain information as long as our services exist. You may access or request deletion of your data by contacting us at <a href="mailto:hello@nxtcrm.ai" className="underline">hello@nxtcrm.ai</a>.
            </p>
