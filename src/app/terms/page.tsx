        ...
        <div className="container">
          <div className="text-center mb-12 max-w-4xl mx-auto">
            ...
            <p className="text-adaptive-secondary text-lg md:text-xl max-w-2xl mx-auto">
              By using nxtcrm.ai, you agree to the terms outlined below. Please read them carefully.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 md:py-16">
        <div className="container max-w-4xl mx-auto">
          <div className="prose prose-lg dark:prose-invert max-w-none">
            ...
            <p className="text-adaptive-secondary">
              You can request membership removal or withdraw from waitlists via <a href="mailto:hello@nxtcrm.ai" className="underline">hello@nxtcrm.ai</a>. Consulting inquiries currently require no cancellation process.
            </p>

            <h2 className="text-3xl font-bold mb-4 text-adaptive">4. Intellectual Property</h2>
            <p className="text-adaptive-secondary">
              All site content, including designs and software, is owned by nxtcrm.ai. Unauthorized copying or redistribution is strictly prohibited.
            </p>
